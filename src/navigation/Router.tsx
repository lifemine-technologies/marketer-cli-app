...
export const Router = () => {
  ...
  if (!authContext) {
    return (
      <View className="flex-1 items-center justify-center bg-gray-50 dark:bg-slate-900">
        ...
        <Text className="mt-4 text-lg text-gray-900 dark:text-slate-100">Initializing...</Text>
      </View>
    );
  }
  ...
  if (userLoading) {
    return (
      <View className="flex-1 items-center justify-center bg-gray-50 dark:bg-slate-900">
        <ActivityIndicator size="large" />
        <Text className="mt-4 text-lg text-gray-900 dark:text-slate-100">Loading...</Text>
      </View>
    );
  }
