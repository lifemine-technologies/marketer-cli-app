...
const geoLocationPointSchema = z.object({
...
export const vendorSchema = z
  .object({
    ...
    pinPoint: geoLocationPointSchema.optional(),
    ...
    serviceArea: z
      .object({
        radius: z
          ...
          .optional(),
        location: geoLocationPointSchema.optional(),
      })
      .optional(),
    isTechnicianAvailable: z.boolean().optional(),
  ...
  .refine(
    data => {
      if (data.isTechnicianAvailable) {
        return data.noOfTechnicians && data.noOfTechnicians > 0;
      }
      return true;
    },
    {
      message:
        'Number of technicians must be greater than 0 if technician is available',
      path: ['noOfTechnicians'],
    },
  );
